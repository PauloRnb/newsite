    ...
    >
      ...
      >
        <div className="flex flex-col gap-1">
          <div className="w-5 h-[2px] bg-gray-600 rounded-full dark:bg-cyan-400 group-focus-visible:bg-blue-700" />
          <div className="w-5 h-[2px] bg-gray-600 rounded-full dark:bg-cyan-400 group-focus-visible:bg-blue-700" />
          <div className="w-5 h-[2px] bg-gray-600 rounded-full dark:bg-cyan-400 group-focus-visible:bg-blue-700" />
        </div>
      </button>
        ...
        >
          ...
          <div className="flex-row sticky bottom-0 flex h-20 min-h-[5rem] w-full items-center gap-6 px-5 py-5">
            ...
            <Link
              ...
              href="/Indicate"
              prefetch
              className="text-base font-medium text-gray-600 dark:text-cyan-400 hover:text-blue-700 dark:hover:text-cyan-500 focus:outline-none transition-colors duration-200 md:text-lg"
            >
              Indique e Ganhe
            </Link>
          </div>
